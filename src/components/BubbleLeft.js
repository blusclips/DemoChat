  ...
  render() {
    ...
    return (
      <TouchableOpacity
        ...
        style={[styles.item, styles.itemIn, { marginBottom }]}
      >
        <View
          style={[
            styles.balloon,
            styles.border,
            { backgroundColor: !currentMessage.image ? "#f5f5f5" : null }
          ]}
        >
          {currentMessage.select ? (
            <View>
              <View style={styles.innerContainer}>
                ...
                >
                  {" "}
                  {currentMessage.select.user.name}{" "}
                </Text>

                <Text style={{ paddingTop: 5, color: "#666" }}>
                  {" "}
                  {currentMessage.select.text}{" "}
                </Text>
              </View>
            </View>
          ) : null}
          ...
          {currentMessage.image && (
            <ImageBackground
              ...
              style={{
                ...
                backgroundColor: !loadImage ? "#b0e0e6" : null
              }}
              borderRadius={5}
